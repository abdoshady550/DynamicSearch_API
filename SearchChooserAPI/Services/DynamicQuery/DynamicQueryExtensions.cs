...
public static class DynamicQueryExtensions
{
    ...
    public static IQueryable<TResult> DynamicSearchAndFilter<TResult>( this IQueryable<TResult> query, string? term,IEnumerable<FilterCriteria>? filters)
       where TResult : class, new()
    {
    ...
    public static IQueryable<TResult> ApplyDynamicQuery<TResult>( this IQueryable<TResult> query,IDynamicQueryRequest<TResult> request)
        where TResult : class, new()
    {
        return query
